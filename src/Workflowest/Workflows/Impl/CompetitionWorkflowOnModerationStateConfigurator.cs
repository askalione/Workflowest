...
{
    class CompetitionWorkflowOnModerationStateConfigurator : ICompetitionWorkflowConfigurator
    {
        private readonly IUserPrincipalProvider _userPrincipalProvider;
        private readonly IActorProvider _actorProvider;

        public CompetitionWorkflowOnModerationStateConfigurator(IUserPrincipalProvider userPrincipalProvider,
